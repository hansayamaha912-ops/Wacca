...
async function fetchAndDecode(url, init) {
  ...
  let NO_BODY_STATUS_CODES2 = /* @__PURE__ */ new Set([100, 101, 204, 205]);
...
function RemixBrowser(_props) {
  if (!router) {
    ...
    router = createRouter({
      ...
      hydrationData,
      mapRouteProperties,
      dataStrategy: window.__remixContext.future.v3_singleFetch && !window.__remixContext.isSpaMode ? getSingleFetchDataStrategy2(window.__remixManifest, window.__remixRouteModules, () => router) : void 0,
...
@remix-run/react/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-F7PJDSWD.js.map
