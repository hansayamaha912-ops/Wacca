...
import {
  ...
  useNavigation,
  useRevalidator
} from "./chunk-F7PJDSWD.js";
import "./chunk-25GAKYL6.js";
import {
  require_react
} from "./chunk-EHE4HQI3.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
...
function requireUseSyncExternalStoreShim_development() {
  ...
  if (true) {
    (function() {
      ...
      var useState11 = React3.useState, useEffect12 = React3.useEffect, useLayoutEffect2 = React3.useLayoutEffect, useDebugValue = React3.useDebugValue;
...
function requireWithSelector_development() {
  ...
  if (true) {
    (function() {
      ...
      var useRef6 = React3.useRef, useEffect12 = React3.useEffect, useMemo10 = React3.useMemo, useDebugValue = React3.useDebugValue;
...
// node_modules/@shopify/hydrogen-react/dist/browser-dev/tracking-utils.mjs
...
function getTrackingValues(cookieString) {
  ...
  if (!trackingValues) {
    ...
    trackingValues = {
      uniqueToken: ((_a3 = cookie.match(/\b_shopify_y=([^;]+)/)) == null ? void 0 : _a3[1]) || "",
  ...
  const productOptions = options.map((option, optionIndex) => {
    return {
      ...
      optionValues: option.optionValues.map((value) => {
        ...
        const handle = (_a3 = variant == null ? void 0 : variant.product) == null ? void 0 : _a3.handle;
        return {
          ...value,
          variant,
          handle,
...
function useShopifyCookies(options) {
  ...
  (0, import_react27.useEffect)(() => {
    if (ignoreDeprecatedCookies || !coreCookiesReady)
      return;
...
function useCoreShopifyCookies({
  ...
  const [cookiesReady, setCookiesReady] = (0, import_react27.useState)(!fetchTrackingValues);
  const hasFetchedTrackingValues = (0, import_react27.useRef)(false);
  (0, import_react27.useEffect)(() => {
    if (!fetchTrackingValues) {
      setCookiesReady(true);
      return;
    }
    if (hasFetchedTrackingValues.current)
      return;
...
async function fetchWithServerCache(url, requestInit, {
  ...
  return runWithCache(
    ...
    async () => {
      ...
      onRawHeaders == null ? void 0 : onRawHeaders(response.headers);
      if (!response.ok) {
        return response;
      }
...
function hasServerTimingInNavigationEntry(key) {
  ...
  try {
    ...
    return !!((_a3 = navigationEntry == null ? void 0 : navigationEntry.serverTiming) == null ? void 0 : _a3.some((entry) => entry.name === key));
  } catch (e) {
    return false;
  }
}
...
function createStorefrontClient2(options) {
  ...
  if (storefrontHeaders == null ? void 0 : storefrontHeaders.buyerIp) {
    defaultHeaders[SHOPIFY_CLIENT_IP_HEADER] = storefrontHeaders.buyerIp;
  }
  if (storefrontHeaders == null ? void 0 : storefrontHeaders.buyerIpSig) {
  ...
  const requestCookie = (storefrontHeaders == null ? void 0 : storefrontHeaders.cookie) ?? "";
  if (requestCookie) defaultHeaders["cookie"] = requestCookie;
  let uniqueToken;
  let visitToken;
  if (!/\b_shopify_(analytics|marketing)=/.test(requestCookie)) {
    const legacyUniqueToken = (_a3 = requestCookie.match(/\b_shopify_y=([^;]+)/)) == null ? void 0 : _a3[1];
    const legacyVisitToken = (_b = requestCookie.match(/\b_shopify_s=([^;]+)/)) == null ? void 0 : _b[1];
  ...
  async function fetchStorefrontApi({
    ...
    const [body, response] = await fetchWithServerCache(url, requestInit, {
      ...
      onRawHeaders: (headers2) => {
        collectedSubrequestHeaders ?? (collectedSubrequestHeaders = {
  ...
  return {
    storefront: {
      ...
      async forward(request, options2) {
        ...
        const storefrontApiVersion = (options2 == null ? void 0 : options2.storefrontApiVersion) ?? ((_a4 = getSafePathname(request.url).match(SFAPI_RE)) == null ? void 0 : _a4[1]);
      ...
      setCollectedSubrequestHeaders: (response) => {
        ...
        const serverTiming = extractServerTimingHeader(
          collectedSubrequestHeaders == null ? void 0 : collectedSubrequestHeaders.serverTiming
        );
        const isDocumentResponse = (_a4 = response.headers.get("content-type")) == null ? void 0 : _a4.startsWith("text/html");
        ...
        collectedSubrequestHeaders.setCookie.length > 1 && (serverTiming == null ? void 0 : serverTiming._y) && (serverTiming == null ? void 0 : serverTiming._s) && (serverTiming == null ? void 0 : serverTiming._cmp)) {
          appendServerTimingHeader(response, {
...
var SeoLogger = (0, import_react28.lazy)(() => import("./log-seo-tags-IG37ONQ2-C2IMGBV6.js"));
function Seo({ debug }) {
...
function Pagination({
  ...
  const NextLink = (0, import_react28.useMemo)(
    () => (0, import_react28.forwardRef)(function NextLink2(props, ref) {
  ...
  const PreviousLink = (0, import_react28.useMemo)(
    () => (0, import_react28.forwardRef)(function PrevLink(props, ref) {
...
var DEFAULT_CUSTOMER_API_VERSION = "2024-10";
...
function defaultAuthStatusHandler(request, defaultLoginUrl) {
  ...
  const redirectTo = defaultLoginUrl + `?${new URLSearchParams({ return_to: pathname }).toString()}`;
...
function createCustomerAccountClient({
  ...
  return {
    ...
    logout: async (options) => {
      ...
      clearSession(session);
      return redirect(logoutUrl, { headers: (options == null ? void 0 : options.headers) || {} });
    },
    isLoggedIn,
    handleAuthStatus,
    getAccessToken,
...
function useCustomerPrivacy(props) {
  ...
  const hasSfapiProxy = (0, import_react28.useMemo)(
    () => sameDomainForStorefrontApi ?? isSfapiProxyEnabled(),
    [sameDomainForStorefrontApi]
  );
  const fetchTrackingValuesFromBrowser2 = (0, import_react28.useMemo)(
    () => hasSfapiProxy && !hasServerReturnedTrackingValues(),
    [hasSfapiProxy]
  );
  const cookiesReady = useShopifyCookies({
    fetchTrackingValues: fetchTrackingValuesFromBrowser2,
    storefrontAccessToken,
    ignoreDeprecatedCookies: true
  });
  const initialTrackingValues = (0, import_react28.useMemo)(getTrackingValues, [cookiesReady]);
  ...
  (0, import_react28.useEffect)(() => {
    const consentCollectedHandler = (event) => {
      ...
      if (onVisitorConsentCollected) {
        ...
        if (customerPrivacy == null ? void 0 : customerPrivacy.shouldShowBanner()) {
...
function useApisLoaded({ withPrivacyBanner }) {
  ...
  const [apisLoadedArray, setApisLoaded] = (0, import_react28.useState)(
...
function ShopifyAnalytics({
  ...
  const [collectedConsent, setCollectedConsent] = (0, import_react28.useState)("");
  ...
  const hasUserConsent = (0, import_react28.useMemo)(
...
function AnalyticsProvider({
  ...
  const [consentCollected, setConsentCollected] = (0, import_react28.useState)(false);
  ...
  return (0, import_jsx_runtime22.jsxs)(AnalyticsContext.Provider, { value, children: [
    ...
    !!shop && (0, import_jsx_runtime22.jsx)(
      ShopifyAnalytics,
      {
        consent,
        onReady: () => {
    ...
    !!shop && consentCollected && (0, import_jsx_runtime22.jsx)(PerfKit, { shop })
  ] });
}
...
function createRequestHandler2({
  ...
  return async (request) => {
    ...
    const storefront = context == null ? void 0 : context.storefront;
    if (proxyStandardRoutes) {
      ...
      if (storefront == null ? void 0 : storefront.isStorefrontApiUrl(request)) {
        const response2 = await storefront.forward(request);
        appendPoweredByHeader == null ? void 0 : appendPoweredByHeader(response2);
        return response2;
      }
    }
    ...
    if (storefront && proxyStandardRoutes) {
      ...
      if (fetchDest && fetchDest === "document" || ((_a3 = request.headers.get("accept")) == null ? void 0 : _a3.includes("text/html"))) {
        appendServerTimingHeader(response, { [HYDROGEN_SFAPI_PROXY_KEY]: "1" });
      }
    }
    appendPoweredByHeader == null ? void 0 : appendPoweredByHeader(response);
    return response;
  };
}
...
export {
  ...
  createRequestHandler2 as createRequestHandler,
